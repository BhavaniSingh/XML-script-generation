        ...
        <Body>
            <NewRx>
                ...
                <MedicationPrescribed>
                    <DrugDescription><xsl:value-of select="/ClinicalDocument/component[1]/structuredBody[1]/component[8]/section[1]/entry[1]/substanceAdministration[1]/consumable[1]/manufacturedProduct[1]/manufacturedMaterial[1]/code[1]/@displayName"/></DrugDescription>
                    <DrugCoded>
                        <ProductCode>
                            <Code><xsl:value-of select="'00054054318'"/></Code>
                            <Qualifier>ND</Qualifier>
                        </ProductCode>
                        <Strength>
                            <StrengthValue><xsl:value-of select="40"/></StrengthValue>
                            <StrengthForm>
                        ...
                        <DrugDBCode>
                            <Code><xsl:value-of select="/ClinicalDocument/component[1]/structuredBody[1]/component[8]/section[1]/entry[1]/substanceAdministration[1]/consumable[1]/manufacturedProduct[1]/manufacturedMaterial[1]/code[1]/@code"/></Code>
                    ...
                    <Sig>
                        <SigText><xsl:value-of select="/ClinicalDocument/component[1]/structuredBody[1]/component[8]/section[1]/text[1]/list[1]/item[1]/content[1]"/></SigText>
                        <CodeSystem>
                        ...
                        <Instruction>
                            <DoseAdministration>
                                ...
                                <RouteOfAdministration>
                                    <Text><xsl:value-of select="/ClinicalDocument/component[1]/structuredBody[1]/component[8]/section[1]/entry[1]/substanceAdministration[1]/routeCode[1]/@displayName"/></Text>
                            ...
                            <TimingAndDuration>
                                <AdministrationTiming>
                                    <AdministrationTimingEvent>
                                        <Text><xsl:value-of select="'morning'"/></Text>
                                        <Qualifier><xsl:value-of select="'SNOMED'"/></Qualifier>
                                        <Code><xsl:value-of select="73775008"/></Code>
                                    </AdministrationTimingEvent>
                                </AdministrationTiming>
                            </TimingAndDuration>
                            <TimingAndDuration>
